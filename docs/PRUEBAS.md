...
| --- | --- |
| Verificación estática del paquete | 180 comprobaciones, 0 fallos |
...
| Pruebas de navegador | 83 aprobadas, 0 fallos |
...
`test-results/static.json`, `test-results/browser.json`, `test-results/unit.tap` y cuatro capturas locales. `docs/INVENTARIO.md` distingue código, recursos y controles aplicados.
